...
import type {GetCastType, GetSrcType, Validator} from '../interface'
import type {AddOptionToUndefined, Simplify} from '../util'

export type GetPropsCast<Props> = Simplify<
    AddOptionToUndefined<{
        [K in keyof Props]: GetCastType<Props[K]>
    }>
>

export type GetPropsSrc<Props> = Simplify<
    AddOptionToUndefined<{
