import {type Codec, address, array, binary, bool, f32, f64, fixedArray, i128, i16, i32, i64, i8, option, ref, string, struct, sum, tuple, u128, u16, u32, u64, u8, unit} from '@subsquid/borsh'
