...
function getPoolPrice(swapEvent: raydiumClmm.events.SwapEvent, tokenIn: TokenBalance, tokenOut: TokenBalance): number {
...
function getSlippage(
    ...
    const expectedInputAmount = swapEvent.zeroForOne ? actualAmount / postPoolPrice : actualAmount * postPoolPrice

    return ((actualInputAmount - expectedInputAmount) / expectedInputAmount) * 100
}
